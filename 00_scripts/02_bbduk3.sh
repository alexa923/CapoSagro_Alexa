#!/bin/bash
#SBATCH --job-name=02_bbduk3
#SBATCH --ntasks=1
#SBATCH -p smp
#SBATCH --mem=1000G
#SBATCH --mail-user=alexa.martin@inrae.fr
#SBATCH --mail-type=ALL
#SBATCH --error=/home/amartin3/CapoSagro_Alexa/00_scripts/02_bbduk3.err
#SBATCH --output=/home/amartin3/CapoSagro_Alexa/00_scripts/02_bbduk3.out

ENTREE="/home/amartin3/01_concatenated_data"
SORTIE="/home/amartin3/02_bbduk3"
QUALITE="/home/amartin3/02_bbduk3/controle_qualite"

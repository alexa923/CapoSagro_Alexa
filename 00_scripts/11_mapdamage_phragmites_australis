#!/bin/bash
#SBATCH --job-name=11_mapdamage_phragmites
#SBATCH --ntasks=1
#SBATCH -p smp
#SBATCH --mem=1000G
#SBATCH --mail-user=alexa.martin@inrae.fr
#SBATCH --mail-type=ALL
#SBATCH --error="/home/amartin3/CapoSagro_Alexa/00_scripts/11_mapdamage_phragmites.err"
#SBATCH --output="/home/amartin3/CapoSagro_Alexa/00_scripts/11_mapdamage_phragmites.out"
...
# Telechargement du génome de Phragmites australis 
#wget -O Phragmites_australis.fna.gz https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/030/534/245/GCA_958298935.1/GCA_958298935.1_lpPhrAust1.1_genomic.fna

#gunzip Phragmites_australis.fna.gz

# Indexation BWA (a faire une seule fois)
bwa index /home/amartin3/genomes/Phragmites_australis.fna
...
# Définition de l'espece cible
declare -A TAXONS=(
    ["Phragmites_australis"]="29695:/home/amartin3/genomes/Phragmites_australis.fna"
)

# Indexation BWA si ce n'est pas encore fait sur le cluster (décommenter si besoin)
# bwa index /home/amartin3/genomes/Phragmites_australis.fna
...
echo "MapDamage termine avec succes pour Phragmites australis."

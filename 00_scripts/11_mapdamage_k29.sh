#!/bin/bash
#SBATCH --job-name=11_mapdamage_k29
#SBATCH --ntasks=1
#SBATCH -p gdec
...
#SBATCH --error="/home/amartin3/CapoSagro_Alexa/00_scripts/11_mapdamage_k29.err"
#SBATCH --output="/home/amartin3/CapoSagro_Alexa/00_scripts/11_mapdamage_k29.out"

# Configuration des chemins pour k29
FASTQ_BASE_DIR="/home/amartin3/05_fastp"
KRAKENTOOLS_DIR="/home/amartin3/08_bracken/KrakenTools"
KRAKEN_DIR_SOURCE="/home/amartin3/07_kraken2_k29"
DAMAGEBASE="/home/amartin3/12_mapdamage_k29"

LOGFILE="${DAMAGEBASE}/mapdamage_k29_$(date +%Y%m%d_%H%M%S).txt"
MAPPING_INFO="${DAMAGEBASE}/mapping_bwa_k29_info.tsv"
...
echo "Script MapDamage K29 started at $(date)" | tee -a "$LOGFILE"
...
echo "MapDamage K29 terminé avec succès."

...
python3 /home/amartin3/08_bracken/KrakenTools/combine_mpa.py \
    -i "$SORTIE/clean_sed6_concat_dedup_merged_bracken.mpa","$SORTIE/clean_sed6_concat_dedup_unmerged_bracken.mpa","$SORTIE/clean_sed8_concat_dedup_merged_bracken.mpa","$SORTIE/clean_sed8_concat_dedup_unmerged_bracken.mpa" \

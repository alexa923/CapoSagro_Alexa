#!/bin/bash
#SBATCH --job-name=11_mapdamage_murinae3
#SBATCH --ntasks=1
#SBATCH -p smp
#SBATCH --mem=1000G
#SBATCH --mail-user=alexa.martin@inrae.fr
#SBATCH --mail-type=ALL
#SBATCH --error="/home/amartin3/CapoSagro_Alexa/00_scripts/11_mapdamage_murinae3.err"
#SBATCH --output="/home/amartin3/CapoSagro_Alexa/00_scripts/11_mapdamage_murinae3.out"
...
#on extrait les reads avec le TaxID des Glires mais on map sur la référence du Rat
declare -A TAXONS=(
    ["Mus_musculus"]="314147:/home/amartin3/genomes/Rattus_norvegicus.fna"
)

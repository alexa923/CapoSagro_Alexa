...
#SBATCH --error="/home/amartin3/CapoSagro_Alexa/00_scripts/00_concatenated_files.err"
#SBATCH --output="/home/amartin3/CapoSagro_Alexa/00_scripts/00_concatenated_files.out"
...
mkdir -p "${Home}/01_concatenated_data"
